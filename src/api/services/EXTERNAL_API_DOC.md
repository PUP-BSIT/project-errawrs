...
└── src/
    └── api/
        └── services/
            ...
            └── EXTERNAL_API_DOC.md     # This documentation
```
...
server {
    ...
    location /api/ {
        root /var/www/dev/src/;

        # External transfer endpoint configuration
        location /api/services/soc_transfer {
            try_files $uri $uri/ /api/services/receive_external.php$is_args$args;
