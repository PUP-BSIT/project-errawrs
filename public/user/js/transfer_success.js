...
document.addEventListener('DOMContentLoaded', function () {
    ...
    dashboardButtons.forEach((button) => {
        button.addEventListener('click', function (e) {
            ...
            window.location.href =
                './user_dashboard.html?transaction_success=true';
        });
    });
    ...
    if (transactionId) {
        ...
        fetch(apiUrl)
            ...
            .then((data) => {
                ...
                if (data.success && data.transaction) {
                    ...
                    ).textContent = t.transaction_id || 'N/A';
                    document.getElementById(
                        ELEMENT_ID.TRANSACTION_DATE
                    ).textContent = t.created_at
                        ? new Date(t.created_at).toLocaleString()
                        : 'N/A';
                    document.getElementById(
                        ELEMENT_ID.TRANSACTION_AMOUNT
                    ).textContent = `${CURRENCY.SYMBOL} ${parseFloat(
                        t.amount || 0
                    ).toLocaleString(CURRENCY.LOCALE, {
                        minimumFractionDigits: 2,
                    })}`;
                    document.getElementById('remaining_balance').textContent =
                        t.sender_new_balance !== null &&
                        t.sender_new_balance !== undefined
                            ...
                            : 'N/A';
                    document.getElementById(
                        ELEMENT_ID.FROM_ACCOUNT
                    ).textContent = t.sender_account_number || 'N/A';
                    document.getElementById(ELEMENT_ID.TO_ACCOUNT).textContent =
                        t.recipient_account ||
                        t.receiver_account_number ||
                    ...
                    document.getElementById(
                        ELEMENT_ID.TRANSACTION_AMOUNT
                    ).textContent = ERROR_MESSAGE.FETCH_ERROR;
                    document.getElementById(
                        ELEMENT_ID.FROM_ACCOUNT
                    ).textContent = 'N/A';
                    document.getElementById(ELEMENT_ID.TO_ACCOUNT).textContent =
            ...
            .catch((err) => {
                ...
                document.getElementById(ELEMENT_ID.TRANSACTION_ID).textContent =
                    'N/A';
                document.getElementById(
                    ELEMENT_ID.TRANSACTION_DATE
                ).textContent = 'N/A';
                ...
                document.getElementById(ELEMENT_ID.FROM_ACCOUNT).textContent =
                    'N/A';
                document.getElementById(ELEMENT_ID.TO_ACCOUNT).textContent =
                    'N/A';
            });
        ...
        document.getElementById(ELEMENT_ID.TRANSACTION_DATE).textContent =
            'N/A';
